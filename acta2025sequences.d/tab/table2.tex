%% table2.tex
  \caption{Results on the maximal repeats enumeration problem. In the table, parameters $r, e_R$, and $e_L$ denote the numbers of BWT-runs, the forward and backward edges of the CDAWG of a text $T$ satisfying the relation $r\le e_R \le n$ and $e_L \le n$. The space is measured in words. 
