...
%% \newcommand{\myfootnote}[1]{\hspace{-0.25em}\footnote{#1}}
...
%% \newcommand{\EBF}{\idrm{EBF}} 
%% \newcommand{\MRW}{\idrm{MRW}}
%% \newcommand{\MRWK}[1][k]{\mbox{$#1$-\idrm{MRW}}}
\newcommand{\MRWS}[1][k]{\idrm{MRW}_{#1}}
\newcommand{\MRWK}[1][k]{\MRWS[k]}
%% \newcommand{\MRWS}[2][S]{\idsf{MRW}_{#2}({#1})}

%%% spire2024
\newcommand{\subword}[1][\SA]{\idtt{subword}_{#1}}
\newcommand{\brep}[1][]{\mbox{\rm\texttt{bi-rep}}_{#1}}
%%\newcommand{\Procedure}{\textbf{procedure}\hspace{0.375em}}
\newcommand{\mr}{\mu}
\newcommand{\eL}{e}
\newcommand{\eR}{e\rev}
%% %% \newcommand{\npos}[1][T]{\idrm{\sharp pos}_{#1}} 
%% \newcommand{\AW}[1][T]{\idsf{AW}({#1})}
%% %\newcommand{\WW}[1][k]{\idsf{W}_k(T)}
%% \newcommand{\MR}[1][T]{\idsf{MR}({#1})}
%% \newcommand{\MAW}[1][T]{\idsf{MAW}({#1})}
%% \newcommand{\MUS}[1][T]{\idsf{MUS}({#1})}
%% \newcommand{\MRW}[1][T]{\idsf{MRW}({#1})}
%% \newcommand{\MRWS}[2][T]{\idsf{MRW}_{#2}({#1})}
%% \newcommand{\W}{\idsf{W}}%

%% \newcommand{\MF}[1][k]{\idsf{MF}_{=#1}(T)}
%% \newcommand{\MFO}[1][k]{{\idsf{MF}}_{\le #1}(T)}


%%% end:spire2025

%%% data structures
\newcommand{\stree}{\idrm{STree}}%exp
\newcommand{\weiner}{\idrm{Weiner}}%exp
%% \newcommand{\CDAWG}{\idrm{CDAWG}}
%% %% \newcommand{\S}{\id{S}}
%% \newcommand{\SA}{\id{SA}}
...
%% \newcommand{\LChar}[1][{\hat S}]{\idrm{L\Sigma}_{#1}}
%% \newcommand{\RChar}[1][{\hat S}]{\idrm{R\Sigma}_{#1}}
%% \newcommand{\getfactor}[1][{\SA, S}]{\op{W}_{#1}} 
%% \newcommand{\getfactor}[1][{\SA, S}]{\op{getFactor}_{#1}} 
%% \newcommand{\isLeftBranching}[1][{\SA, \ISA, S}]{\proc{isLeftBranching}_{#1}}\newcommand{\RREP}{\mathcal{RP}}  %% TDSA
 

%%% algo
%% \newcommand{\MREnum}{\textsf{EnumMR}}  %% TDSA
%% \newcommand{\MRRec}{\textsf{RecMR}}  %% TDSA
%% \newcommand{\GenChildren}[1][{\LCP, \SA, S}]{\textsf{GenChildren}_{#1}}  
