...
\newcommand{\repl}[1][S]{\op{repl}_{#1}}
\newcommand{\fact}[1][S]{\op{fact}_{#1}}
...
\newcommand{\GenChildren}[1][]{\textsf{GenRbChildren}_{#1}}  
\newcommand{\ColoredRange}[1][]{\textsf{ColoredRange}_{#1}}  
\newcommand{\append}{\op{append}}

\newcommand{\LC}[1][S]{\idrm{LC}_{#1}}
\newcommand{\RC}[1][S]{\idrm{RC}_{#1}}
%% \newcommand{\LC}[1][S]{\idrm{LChar}_{#1}}
%% \newcommand{\RC}[1][S]{\idrm{RChar}_{#1}}
\newcommand{\getfactor}[1][{\SA, S}]{\op{Fact}_{#1}} 
\newcommand{\isLeftBranching}[1][{\SA, \ISA, S}]{\proc{isLeftBranching}_{#1}}\newcommand{\REPL}{\mathsf{REP}}  %% TDSA
...
\newcommand{\mysubsection}[1]{\medskip\textbf{#1}.\hspace{0.125em}}%% camera
